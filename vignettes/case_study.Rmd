...
1. Simulate extreme dataset (as in RiME talk).

2. See example dataset provided by Belay. Add (a subset of) this to bundle with the package? (Need to check its provenance.)
